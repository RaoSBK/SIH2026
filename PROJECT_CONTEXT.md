...
1. **Canonical / Live Pipeline**: [`backend/app/ingestion/ner.py`](file:///d:/SIH2026/backend/app/ingestion/ner.py) (629 lines) + [`backend/app/ingestion/resolver.py`](file:///d:/SIH2026/backend/app/ingestion/resolver.py) (740 lines). Wired directly to `POST /api/process-evidence` in `main.py` via `backend/app/ingestion/service.py`. Candidate fuzzy resolution is strictly case-scoped (`case_id` filtered).
